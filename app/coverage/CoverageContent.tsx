      ...
      <section className="relative py-24 md:py-32 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <motion.div
            ...
            <span className="font-barlow font-bold text-sm uppercase tracking-wider text-[#EFF2F7]">Uthukottai</span>
            ...
            <span className="font-barlow font-bold text-sm uppercase tracking-wider text-[#EFF2F7]">Periyapalayam</span>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <motion.div className="rounded-2xl overflow-hidden h-[400px] md:h-[500px]"
            ...
            <iframe
              ...
              title="Wings Delivery Coverage Map — Uthukottai to Periyapalayam, Tiruvallur, Tamil Nadu" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <motion.a
              href="https://wa.me/917603814870?text=Hi%20Wings%20Delivery!%20I%20want%20to%20request%20delivery%20to%20my%20village."
