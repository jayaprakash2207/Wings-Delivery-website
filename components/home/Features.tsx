...
const features = [
  ...
  { icon: Mic, title: 'Voice notes work', body: "Can't type? Send a voice note in Tamil. Our Gemini AI transcribes and understands it perfectly." },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {features.map(({ icon: Icon, title, body }, i) => (
            <motion.div key={title}
              className="card p-7 flex flex-col gap-5 group cursor-default"
